...
#figure(placement: none, gap: .75em,
  box(image("../img/basin.svg"),
    clip:true,
    inset: (top:-10pt, bottom:-10pt, left:-30pt, right:-80pt),
    stroke: none),
  caption: [Square basin geometry]
)<basin>

The mesh of the previous case study contains about 13 000 cells.
...
we need to ensure each computational core receives sufficient workload to assess the real benefits
...
level is uniformly set to $#qty[1][[m]]$ across the domain, resulting in a fully wet simulation. The large scale
...
#figure(placement: none,
  ...
  box(image("../img/basin_5.png"), clip: true, inset: (left: ins, right: ins, top: 3*ins, bottom: 3*ins)),
  box(image("../img/basin_33.png"), clip: true, inset: (left: ins, right: ins, top: 3*ins, bottom: 3*ins)),
  grid.cell(colspan: 2,
  box(image("../img/basin_59.png", width: 55%), clip: true, inset: (left: ins, right: ins, top: 3*ins, bottom: 3*ins))
  ),
  grid.cell(colspan: 2,
