...
table(
  ...
  [Petaccia et al. @Petaccia2016], [OpenMP], [Intel \ Core i7 \ 3.4 GHz], [Roe], [Unstruct.], [200 000 \ Dry/Wet], [*2.35$times$/4 cores*],
  table.hline(stroke: .5pt),
...
caption: [Overview of reported speedups compared to serial implementations
]
)<TableSpeedups>
